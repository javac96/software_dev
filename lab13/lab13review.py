...
class Chair:
    ...
    def __init__(self, height, width, length):
        ...
        self.__width = width # double underscore (__) makes the property 'width' to be very private
    ...
    # method to return the volume fo the chair
    ...
    def chair_description(self):
        return f"The total volume of the chair {self.chair_volume()}. \nThe chair color is {self.get_color()}"

    # method with a private property (single underscore for private)
